...
;we need to repopulate var furthest_point
            ...
            ;  call get_distance     ; got to get how far we can see again
             ...
             call draw_side_walls
              ...
              call draw_colours     ;colourise the dispaly
...
_chars:
 ...
 db	0,0,0,0,0,0,0,0	;8a	65160		
	...
	db	255,0,255,0,255,0,255,0	;8d	65184		
db	    	  ;8e	small wall stretched
;db 240,15,224,31,224,15,112,15	   	  ;8e	small wall stretched
...
db 255,255,255,255,0,0,0,0         ;c1 bottom right section 3 (5)
db 255,255,255,255,255,0,0,0       ;c2 bottom right section 3 (6)
db 255,255,255,255,255,255,0,0     ;c3 bottom right section 3 (6)
db 255,255,255,255,255,255,255,255 ;c4 bottom right section 3 (6)

;layer 5 section 3 left BOTTOM TBD

db 255,255,255,255,0,0,0,0         ;c5 bottom right section 3 (5)
db 255,255,255,255,255,0,0,0       ;c6 bottom right section 3 (6)
db 255,255,255,255,255,255,0,0     ;c7 bottom right section 3 (6)
db 255,255,255,255,255,255,255,255 ;c8 bottom right section 3 (6)

;db	6,192,12,96,3,192,6,112       	 ;c9	small wall stretched more
