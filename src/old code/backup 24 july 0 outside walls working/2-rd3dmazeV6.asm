...
blue_ink:     ; set blue ink for walls
              ld a, paper
              rst $10
              ld a, green
              rst $10
...
; now draw the maze
testm
              ld hl,maze-16   ; start of maze
              ld d,16       ; 1 line length across
              ld c,19       ; 18 lines down, we exit on 0
repeat:       ld a,(hl)
              ld b,a
...
final_draw:   ld a,35;88           ;$94          ; $8f for black block
              rst $10
...
setbase push af
        ...
        sub $90                   ;point to the first character of udg's 
        ld bc,udg_start;64216-16 ;65368 ;304 ;65112 ;65368         ;start of udg's in memory
        ld (base),bc
        ;ld hl,(base)
ret_1   pop hl
        pop bc
...
do_exit:      pop af
              pop de
              pop bc
              call show_dir     ; highlight player direction
              ret
