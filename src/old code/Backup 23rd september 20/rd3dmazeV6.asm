...
;              call compass         ; draw compass
              ...
              ld hl,$0175        ;start address in disp file for wall 5 left drawing
              ld (w5_start),hl
...
w5_start dw 0        ;wall 5 start position - we use routine multiple times
