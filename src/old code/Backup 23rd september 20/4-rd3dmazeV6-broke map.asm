...
;1 = 4th left wall
        ...
        call draw_5S             ;jump straight to making an end wall
...
a5_1:   cp 3
        ...
        add a,128               ;make sure we set a wall!
        call do_2ndwall_l        ;draw the 2nd block to the left
        jr go_back5              ; jump back to main loop
...
a5_2:   cp 2
        ...
        ld b,a                  ;make the bc count 1 so we only draw 1 wall
        add a,128               ;make sure we set a wall!
        call do_3rdwall_l       ;draw the 2nd block to the left
        jr go_back5              ; jump back to main loop
...
a5_3:   ld a,1
        ld b,a                  ;make the bc count 1 so we only draw 1 wall
        add a,128               ;make sure we set a wall!
        call do_4thwall_l       ;draw the cnd block to the left
        jr go_back5              ; jump back to main loop
...
;b=3 for 3rd block to the left.
        ...
        sub 1
        jr nz,cont1
        call z,do_4thwall_l       ;draw the cnd block to the left
        jr go_back5              ; jump back to main loop

cont1:  ld a,b                  ;b is our loop count
        sub 2                   ;check if a=2
        jr nz,cont2
        call z,do_3rdwall_l       ;draw the 2nd block to the left
        jr go_back5              ; jump back to main loop

cont2:  ld a,b
        sub 3
        jr nz,cont3
        call z,do_2ndwall_l       ;draw the cnd block to the left
        jr go_back5              ; jump back to main loop

cont3:  ld a,b
        sub 4
        jr nz,go_back5              ; jump back to main loop
        call do_1stwall_l       ;draw the cnd block to the left
        jr go_back5              ; jump back to main loop
