...
;first, set hl to our map
              ...
              ld a,(cur_map)    ;get our map
              push af           ;save it as we need to put it back later
              inc a
              call set_map      ;point to the next map above us
...
draw_U5L:
        call get_maze_location
              ...
              ld hl,$0175 - 32      ;start address in disp file for wall 5 left drawing
                                    ;1 line above us
              ld (w5_start),hl
;              call draw_5
              ret
