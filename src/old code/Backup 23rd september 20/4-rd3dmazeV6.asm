...
;sept2020 - made this routine such that it can be called
;from any layer drawing routine - saves space!
...
;remaining blocks to test if there is a wall there or not.
        ...
        ld (var3),de
        ld de,(w5_start) ;$0175           ; offset to row 11 column 10 - left of  centre of the 3d view.
        call do_draw_5
        
;id de <> $175 then we called this routine from elsewhere so need to
;ret and not jump onwards
        ld de,(w5_start)
        ld a,e
        sub $75
        ret nz
...
cont2:
        ...
        sub 3
        jr nz,cont3
        call do_2ndwall_l       ;draw the cnd block to the left
        jp go_back5              ; jump back to main loop
