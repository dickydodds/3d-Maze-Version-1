...
a3:     ld a,1
        ld b,a                  ;make the bc count 1 so we only draw 1 wall
        add a,128               ;make sure we set a wall!
        jp draw_10r_2L	       	;draw the 2nd wall to the right
...
;        jp z,draw_10r          ;draw an end wall if blockid=16
        ...
        ld a,b
        sub 2
        jp z,draw_10         		;draw the 1st wall to the right

        ld a,b 
        sub 1
        jp z,draw_10r_2L	       	;draw the 2nd wall to the right
