...
draw_attr_top:                  ; draw top blue sky
              ...
              ld de,$c300       ; start of attributes after ZX81 display in memory
...
loop_4          dec bc           ;change ldir count
              ...
              ; 22912 is the start of the floor level
               ...
               ld hl,colour_map+383   ; start of first floor line
