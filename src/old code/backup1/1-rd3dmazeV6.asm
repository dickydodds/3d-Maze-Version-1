...
screen_mem equ $c000   ;49152  ZX81 screen char map
colour_map equ $c300  ;colour map in memory after ZX81 screen char map
...
;################################################################
; routine to copy the colours to the screen 
; from colour memory map at $D300
;################################################################

copy_colours:     
;              ei
;              halt              ;wait for next scanline for clean copy
;              di
