...
wall4_start:
        ...
        ld a,b
        sub 3                   ;1 = 3rd wall immediately to the right
        jp z,draw_9r_2

        ld a,b
        sub 2                   ;1 = wall immediately to the right
        jp z,draw_9r_3
...
wall3_start:
        ...
        ld a,b 
        sub 1
        jp z,draw_10r_3	       	   ;draw the 3rd wall to the right
...
draw_10r_3: 
         ...
         push bc
         push de
         ld hl,$C141            ;start print position of wall
...
;check if a wall is already drawn. If so, dont draw a black wall.
        ...
        pop de
        pop bc
        jp z,go_back3r              ; jump back to main loop if brick already drawn
...
j3:     ld hl,$C141         ;start print position of wall
        ld de,$21
        ld a,$ca            ;top corner
        ld (hl),a        
        add hl,de
