...
;start on maze map 1  - dont use 0 :)
...
;              call compass         ; draw compass
            ...
            ;  call get_distance    ; got to get how far we can see again
              ...
              call draw_colours     ;colourise the display but in $c300

              call copy_colours     ; copy colour map to spectrum screen
...
set_map:
        ...
        ld hl,map_1             ;start of map data 256 bytes each
