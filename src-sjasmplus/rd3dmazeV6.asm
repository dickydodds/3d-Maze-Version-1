...
;remember to set maze_highbyte for current maze
              ...
              ld h,$72          ;set at maze 1 bottom maze             
;start on maze0
...
;##########################################################
              ...
              inc a
              jp nz,cont_9          ;carry on if not at north wall
...
;extra layer 5 chars
 db	249,63,243,159,244,47,249,143 	 ;8e	small wall stretched (layer 3)
 db	255,140,255,38,255,140,255,38 	 ;8e	small wall stretched (layer 3)
;db	255,204,153,255,38,255,140,255 	 ;8e	small wall stretched (layer 3)
